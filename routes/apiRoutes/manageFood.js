...
module.exports = app => {
    app.get('/api/getFood/:search', async (req, res) => {
    ...
    app.get('/api/datePicker/:date/:token', async (req, res) => {
    ...
    app.get('/api/editFoods/:formattedDate/:token/:foodName', async (req, res) => {
        const {
            formattedDate,
            token,
            foodName
    ...
    app.get('/api/nutritionInfo/:foodName', async (req, res) => {
    ...
    app.post('/api/saveFood/:token', async (req, res) => {
    ...
    app.patch('/api/editFoods/update/:id/:weight/:foodName', async (req, res) => {
        const {
            id,
            weight,
            foodName
    ...
    app.delete('/api/editFoods/delete/:id/:foodName', async (req, res) => {
        const {
            id,
            foodName
        } = req.params;
